...
```sh
mongodb+srv://andrew:<password>@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
...
```sh
mongodb+srv://andrew:123123123@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
