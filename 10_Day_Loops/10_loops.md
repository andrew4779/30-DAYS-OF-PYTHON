...
1. Go to the data folder and use the [countries.py](https://github.com/Andrew/30-Days-Of-Python/blob/master/data/countries.py) file. Loop through the countries and extract all the countries containing the word _land_.
1. This is a fruit list, ['banana', 'orange', 'mango', 'lemon'] reverse the order using loop.
2. Go to the data folder and use the [countries_data.py](https://github.com/Andrew/30-Days-Of-Python/blob/master/data/countries-data.py) file. 
